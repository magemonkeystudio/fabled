import { filteredConditions } from './../components/registry';
/**
 * @license
...
export class BlockSearcher {
  private blockNames = new Map<string, string>();
  ...
  indexBlocks(blockTypes: string[]) {
    ...
    blockTypes.forEach((blockType) => {
      ...
      if (name) this.indexBlockText(name, blockType);
    });
  }
