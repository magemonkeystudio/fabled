...
type LayoutRouteId = RouteId | "/" | "/(app)/[type=istype]/[id]" | "/(app)/[type=istype]/[id]/edit" | null
type LayoutParams = RouteParams & { type?: MatcherParam<typeof import('../../../../src/params/istype').match>; id?: string }
