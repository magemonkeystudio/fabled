...
-   **No YAML Blocks:** Do NOT provide users with raw YAML code blocks. This is critical.
...
-   **Core Skill Structure:** The heart of Fabled is its component system for skills. A skill is built by combining four types of components:
    ...
    4.  **Mechanics:** These are the actual actions the skill performs. This is what the skill *does*, such as dealing damage (`DamageMechanic`), healing (`HealMechanic`), or launching an entity (`LaunchMechanic`).
-   **Class System:**
