[![Build](https://github.com/magemonkeystudio/fabled/actions/workflows/release.yml/badge.svg?branch=main)](https://repo.travja.dev/releases/studio/magemonkey/fabled/1.0.4-R0.78-SNAPSHOT)
[![Build](https://github.com/magemonkeystudio/fabled/actions/workflows/devbuild.yml/badge.svg?branch=dev)](https://repo.travja.dev/snapshots/studio/magemonkey/fabled/1.0.4-R0.78-SNAPSHOT)
...
<dependency>
    ...
    <version>1.0.4-R0.78-SNAPSHOT</version>
</dependency>
```
