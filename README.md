...
[![Build](https://github.com/promcteam/fabled/actions/workflows/devbuild.yml/badge.svg?branch=dev)](https://s01.oss.sonatype.org/content/repositories/snapshots/studio/magemonkey/fabled/1.0.0-R0.48-SNAPSHOT/)
...
<dependency>
    ...
    <version>1.0.0-R0.48-SNAPSHOT</version>
</dependency>
```
