...
function MechanicStat()
{
    ...
    this.data.push(new ListValue('DisplayName', 'key', ['health', 'mana', 'mana-regen', 'physical-damage', 'melee-damage', 'projectile-damage', 'physical-damage', 'melee-defense', 'projectile-defense', 'skill-damage', 'skill-defense', 'move-speed', 'attack-speed', 'armor', 'luck', 'armor-toughness', 'exp', 'hunger', 'hunger-heal', 'cooldown', 'knockback-resist'])
