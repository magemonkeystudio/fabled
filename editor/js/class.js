...
function Class(name)
{
	...
	this.data = [
		...
		new ListValue('Skill Tree', 'skill-tree', [ 'Basic Horizontal', 'Basic Vertical', 'Level Horizontal', 'Level Vertical', 'Flood', 'Requirement' , 'Custom'], 'Requirement').setTooltip('The skill arrangement in the skill tree. Select "Custom" for a tree editable through the customize command.'),
